...
import '../../styles/Hod/Evaluate.css';

const Evaluate = ({ facultyId }) => {
    const [evaluations, setEvaluations] = useState([{ rollNo: '', groupId: '', marks: '' }]);
    const [activeRole, setActiveRole] = useState(''); // State for active role
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('/api/evaluate-marks', { facultyId, activeRole, evaluations });
            setMessage(response.data.message);
            setEvaluations([{ rollNo: '', groupId: '', marks: '' }]); // Reset the form
            setActiveRole(''); // Reset active role
        } catch (err) {
            ...
            <form onSubmit={handleSubmit}>
                <div className="form-group">
                    ...
                    >
                        ...
                        <option value="projectPanel">Project Panel</option>
                    </select>
                </div>
